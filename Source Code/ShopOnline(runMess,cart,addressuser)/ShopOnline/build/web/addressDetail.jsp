                        ...
                        <div class="col-lg-5 col-md-5">
                            <div style="border-right: 1px solid #231f20;">
                                ...
                                <div class="options ">
                                    ...
                                    <span style="width: 100%"><input style="width: 99%" id="straddress" name="straddress"  type="text" value="${valueAddress}" placeholder="Address..." onclick="onClickAddress()"  onblur="outSearchAddress()"	ondblclick ="onKeydownAdress()"> <!--onclick để hiển thị select, 	onkeydown ẩn select-->
                                        <i class="fa-solid fa-magnifying-glass" style="margin-left: -50px;cursor: pointer" onclick ="onKeydownAdress()"></i></span>
                                ...
                                <div id="googleMap" style="width: 100%;height: 0"></div>           
                            </div>
                            <div class="options">
