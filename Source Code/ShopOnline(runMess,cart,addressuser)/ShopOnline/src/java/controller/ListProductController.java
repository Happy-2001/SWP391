...
//        ProductDAO productDAO = new ProductDAO();
//        response.getWriter().print((actionpage==null)+"|"+(productName==null)+"|"+(categoryId==null)+"|"+(productPrice==null)+"|"+(productStock==null)+"|"+"|"+(description==null)+"|"+(image==null));
