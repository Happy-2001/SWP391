...
public class FeedbackController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String myfeedbackID = request.getParameter("myfeedbackID");
        ...
        if (myfeedbackID != null) {
            fb.updateFbforCus(reply, rate, myfeedbackID);
            MyFeedback myfb = fb.getFeedbackById(Integer.parseInt(myfeedbackID));
            request.setAttribute("myfb", myfb);
        } else {
