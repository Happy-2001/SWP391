...
public class User {
    ...
    public User(int userid, String username, String firstname, String middlename, String lastname,  int gender, Date dob, int status, String email, String photo, Role authority) {
        this.userid = userid;
