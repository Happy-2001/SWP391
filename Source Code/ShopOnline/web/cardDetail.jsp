                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column">
                                            <span><strong>300.000</strong><i class="fa-solid fa-dong-sign"></i></span>
                                            <div class="d-flex flex-row">
                                                <span class="pe-3"><i class="fa-regular fa-heart remove-icon"></i></span>
                                                <span><i class="fa-regular fa-trash-can remove-icon"></i></span>
                                            </div>
                                        </div>
                                    </td>
                                    <form id="frmid" action="UpdateCartController" method="POST">
                                        <td>
                                            <div class="input-group">
                                                <input type="hidden" name="id" value="${carts.item_id}">
                                                <button type="submit" class="input-group-text"><i class="fa-solid fa-minus"></i></button>
