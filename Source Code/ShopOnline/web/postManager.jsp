                ...
                <tbody>
                    <c:forEach items="${posts}" var="post">
                        <tr>
                            ...
                            <td></td>
                            <td>
                                <img src="${post.image}" style="width: 100px !important; height: 100px !important;" class="img-thumbnail">
                            </td>
                            <td>
                                <a class="btn btn-success" href="ManagePost?action=edit&id=${post.id}">Edit</a>
                                <a class="btn btn-danger" onclick="deleteB('${post.id}')">Delete</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
