                    ...
                    <div class="content">
                        <div class="profile-cover bg-image mb-4" style="background: url(&quot;../images/profile-bg.jpg&quot;);">
                            <div class="avatar-profile">
                                ...
                                <div class="del-btn">
                                    <a href="AddSupplier?action=delete&id=${supAdd.sup.id}" class="btn btn-icon" data-bs-toggle="tooltip" title="Remove Customers">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="d-flex gap-3">
                                                                    <select class="form-select">
                                                                            ...
                                                                            <c:if test="${sup.gender == 1}">
                                                                                <option value="1" selected>Male</option>
                                                                                <option value="0">Female</option>
                                                                            </c:if>
                                                                                
                                                                            <c:if test="${sup.gender == 0}">
